...
export const nl: Record<TranslationKey, string> = {
  ...
  tasksDescription: 'Start de server automatisch opnieuw op, voer consoleopdrachten uit of laat aankondigingen rouleren volgens een schema.',
  tasksName: 'Naam',
  tasksNamePlaceholder: 'Nachtelijke herstart',
  tasksType: 'Type',
  tasksTypeRestart: 'Herstart',
  tasksTypeCommand: 'Opdracht',
  tasksTypeAnnounce: 'Aankondigingen',
  tasksMessages: 'Berichten',
  tasksMessagesHint: 'Eén bericht per regel, op volgorde verstuurd en herhaald. Kleurcodes zoals &a en &l werken. Alleen Java.',
  tasksMessagesRequired: 'Voeg minstens één bericht toe',
