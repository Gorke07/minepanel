...
export const es: Record<TranslationKey, string> = {
  ...
  tasksDescription: 'Reinicia el servidor, ejecuta comandos de consola o rota anuncios automáticamente según un horario.',
  tasksName: 'Nombre',
  tasksNamePlaceholder: 'Reinicio nocturno',
  tasksType: 'Tipo',
  tasksTypeRestart: 'Reinicio',
  tasksTypeCommand: 'Comando',
  tasksTypeAnnounce: 'Anuncios',
  tasksMessages: 'Mensajes',
  tasksMessagesHint: 'Un mensaje por línea; se envían en orden y se repiten. Funcionan códigos de color como &a y &l. Solo Java.',
  tasksMessagesRequired: 'Añade al menos un mensaje',
