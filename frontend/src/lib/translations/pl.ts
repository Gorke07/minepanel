...
export const pl: Record<TranslationKey, string> = {
  ...
  tasksDescription: 'Automatycznie restartuj serwer, uruchamiaj polecenia konsoli lub rotuj ogłoszenia według harmonogramu.',
  tasksName: 'Nazwa',
  tasksNamePlaceholder: 'Nocny restart',
  tasksType: 'Typ',
  tasksTypeRestart: 'Restart',
  tasksTypeCommand: 'Polecenie',
  tasksTypeAnnounce: 'Ogłoszenia',
  tasksMessages: 'Wiadomości',
  tasksMessagesHint: 'Jedna wiadomość na linię, wysyłane po kolei i powtarzane. Kody kolorów jak &a i &l działają. Tylko Java.',
  tasksMessagesRequired: 'Dodaj co najmniej jedną wiadomość',
