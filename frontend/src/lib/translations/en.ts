export const en = {
  ...
  tasksDescription: 'Automatically restart the server, run console commands or rotate announcements on a schedule.',
  tasksName: 'Name',
  tasksNamePlaceholder: 'Nightly restart',
  tasksType: 'Type',
  tasksTypeRestart: 'Restart',
  tasksTypeCommand: 'Command',
  tasksTypeAnnounce: 'Announcements',
  tasksMessages: 'Messages',
  tasksMessagesHint: 'One message per line, sent in order and repeated. Color codes like &a and &l work. Java only.',
  tasksMessagesRequired: 'Add at least one message',
