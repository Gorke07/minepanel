...
export const de: Record<TranslationKey, string> = {
  ...
  tasksDescription: 'Server automatisch neu starten, Konsolenbefehle ausführen oder Ankündigungen nach Zeitplan rotieren.',
  tasksName: 'Name',
  tasksNamePlaceholder: 'Nächtlicher Neustart',
  tasksType: 'Typ',
  tasksTypeRestart: 'Neustart',
  tasksTypeCommand: 'Befehl',
  tasksTypeAnnounce: 'Ankündigungen',
  tasksMessages: 'Nachrichten',
  tasksMessagesHint: 'Eine Nachricht pro Zeile, der Reihe nach gesendet und wiederholt. Farbcodes wie &a und &l funktionieren. Nur Java.',
  tasksMessagesRequired: 'Füge mindestens eine Nachricht hinzu',
  tasksCommand: 'Befehl',
